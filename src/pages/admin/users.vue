<template>
	<div>
		<el-dialog :title="title" :visible="visible" :before-close="close" width="30rem">
			<el-form :model="obj" label-width="8rem" :rules="rules" ref="theForm" > 
			    ...
			    <el-form-item label="登录名"  prop="username">
					<el-input v-model="obj.username" auto-complete="off" ></el-input>
				</el-form-item>
				  <el-form-item label="密码"  prop="unencodePassword">
					<el-input v-model="obj.unencodePassword" auto-complete="off" ></el-input>
				 </el-form-item>
			</el-form>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true">
				<el-form-item  label="姓名" label-width="5rem">
		...
		<el-table :data="datas" border style="width: 100%" v-loading="listLoading">
			...
			<el-table-column prop="username" label="登陆名">
			</el-table-column>
